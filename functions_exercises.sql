...
select UPPER(concat (first_name,' ',last_name) ) as Full_Name, 
hire_date, DATEDIFF(now(),hire_date) as DateDiff
from employees
...
/* Use your knowledge of built in SQL functions to generate a username for all of the employees.
 ...
 select emp_no, lower( concat(left(first_name,1),left(last_name,4),'_',substr(birth_date,6,2), substr(birth_date,-8,2))) as username
 from employees
